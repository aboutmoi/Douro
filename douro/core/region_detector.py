...
class RegionDetector:
    ...
    def __init__(self):
        ...
        self.region_patterns = {
            ...
            'gcp': {
                ...
                'europe-west2': [r'europe-west2', r'ew2', r'london'],
                'europe-west3': [r'europe-west3', r'ew3', r'frankfurt'],
                'europe-west4': [r'europe-west4', r'ew4', r'netherlands', r'eemshaven'],
                'asia-southeast1': [r'asia-southeast1', r'as1', r'singapore'],
                'asia-northeast1': [r'asia-northeast1', r'an1', r'tokyo'],
            },
            # Microsoft Azure
            'azure': {
            ...
            # OVH
            'ovh': {
                'gra7': [r'gra\d*', r'gravelines', r'gra7'],
                'gra9': [r'gra9', r'gravelines9'],
                'rbx8': [r'rbx\d*', r'roubaix', r'rbx8'],
                'sbg5': [r'sbg\d*', r'strasbourg', r'sbg5'],
                'bhs5': [r'bhs\d*', r'beauharnois', r'montreal', r'bhs5'],
                'waw1': [r'waw\d*', r'warsaw', r'poland', r'waw1'],
                'lon1': [r'lon\d*', r'london', r'lon1'],
                'fra1': [r'fra\d*', r'frankfurt', r'fra1'],
                'sin1': [r'sin\d*', r'singapore', r'sin1'],
                'syd1': [r'syd\d*', r'sydney', r'australia', r'syd1'],
            },
            # Cloudflare
            'cloudflare': {
            ...
            'github': {
                'fra': [r'fra', r'frankfurt', r'de-cix\.fra'],
                'sea': [r'sea', r'seattle'],
    ...
    def run_mtr(self, target: str, max_hops: int = 12) -> List[str]:
        ...
        try:
            # Essayer MTR (My Traceroute) - plus fiable que traceroute
            cmd = [
                'sudo', 'mtr', 
                '-4',  # Force IPv4
                '--report', 
                ...
                '-n',  # No DNS resolution pendant MTR (on le fera après)
                target
            ]
            ...
            if result.returncode == 0:
                ...
                # Fallback sur MTR sans sudo (moins précis mais fonctionne parfois)
                logging.debug(f"MTR avec sudo a échoué, essai sans sudo pour {target}")
                cmd = [
                    'mtr', 
                    '-4', '--report', '--report-cycles', '2', 
                    '--max-ttl', str(max_hops), '-b', target
                ]
                result = subprocess.run(
                    cmd, 
                    capture_output=True, 
                ...
                if result.returncode == 0:
                    ...
                    # Dernier fallback sur traceroute classique
    ...
    def _identify_provider(self, hostname: str) -> Optional[str]:
        ...
        provider_indicators = {
            ...
            'gcp': ['googleapis.com', 'google.com', 'gcp', 'googlers.com'],
            'azure': ['azure.com', 'microsoft.com', 'azureedge.net'],
            'ovh': ['ovh.net', 'ovh.com', 'kimsufi.com', 'soyoustart.com'],
